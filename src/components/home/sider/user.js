    ...
    <>
      <div className="w-[100%] flex items-center justify-center">
        <div className="flex gap-3 items-center">
          ...
          <div>
            <p className="p-0">Personal</p>
            <span className="flex items-center">
              Free<span className="yAVqVg">•</span>
              <span>
                <span className="flex items-center">
                  <span aria-hidden="true" className="R3BUpw dkWypw">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 24 24"
